...
| [Development](development/architecture.md) | Architecture and contributing || [Operations](operations/index.md) | Runbooks, deployment, validation |

!!! note "Historical Documentation"
    Archived docs (audits, implementation plans, milestones) are in [`docs/history/`](https://github.com/julianbartosz/solver-agentic-spec-coworker/tree/main/docs/history) on GitHub. These are excluded from the docs site but preserved for reference.
## License
