...
class DetectedProfile:
    ...
    Attributes:
        ...
        workspace_roots: List of workspace/package roots detected (for monorepos)
        selected_workspace_root: The workspace root chosen for code generation
    """
    ...
    # G-02: Workspace boundary support for monorepos
    workspace_roots: List[str] = field(default_factory=list)  # All detected workspace roots
    selected_workspace_root: Optional[str] = None  # The workspace chosen for this run
...
class RepoProfile:
    ...
    # G-02: Workspace boundary support for monorepos
    workspace_root: Optional[str] = None  # Selected workspace root (constrains all writes)
    is_monorepo: bool = False  # True if repo has multiple workspace roots
