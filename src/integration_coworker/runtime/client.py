...
from integration_coworker.runtime.auth import BaseAuth, NoAuth
from integration_coworker.runtime.retry import BaseRetry, NoRetry
from integration_coworker.runtime.rate_limit import BaseRateLimiter, NoRateLimiter
...
class IntegrationClient:
    ...
    def __init__(
        ...
        # Lazy-load httpx to avoid hard dependency
        self._http = None
