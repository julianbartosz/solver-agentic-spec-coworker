...
| Document | Purpose |
|----------|---------|
| [Getting Started](docs/getting-started/installation.md) | Installation, database setup, LLM config |
| [Architecture](docs/development/architecture.md) | System architecture, LangGraph pipeline, Silver/Gold medallion model |
| [Code Tour](docs/development/code-tour.md) | 60-90 minute codebase walkthrough for onboarding |
| [Live Fire Demo](docs/LIVE_FIRE_DEMO_GUIDE.md) | 10-minute demo script with expected outputs |
| [Roadmap](docs/ROADMAP.md) | 30/60/90 day priorities |

For design decisions, see [`docs/decisions/`](docs/decisions/).

> **Note:** Historical documentation (milestones, audits, implementation plans) is archived in [`docs/history/`](docs/history/). These files are preserved for reference but excluded from the docs site build.
