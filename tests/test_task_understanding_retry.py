...
class TestCallLLMWithRetry:
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_success_on_first_try(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_retries_on_empty_response(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_retries_on_error_response(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_retries_on_missing_task_slug(self, mock_llm):
...
class TestUnderstandTaskDegradedMode:
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_llm_success_no_degraded_mode(self, mock_llm):
...
constraints.requires_webhooks=false"""
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_llm_failure_sets_degraded_mode(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_all_retries_exhausted_sets_degraded_mode(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_heuristic_fallback_produces_valid_task(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_tracks_task_source(self, mock_llm):
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_heuristic_tracks_task_source(self, mock_llm):
...
class TestUnderstandTaskCompletedSteps:
    ...
    @patch("integration_coworker.graph.nodes.understand_task.call_llm")
    def test_adds_to_completed_steps(self, mock_llm):
    ...
    def test_no_task_description_adds_error(self):
