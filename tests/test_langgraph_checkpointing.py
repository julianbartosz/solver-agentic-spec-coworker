...
class TestSitePackagesIntegrity:
    ...
    def test_python_version_is_3_11(self):
        ...
        if sys.version_info.minor != 11:
            pytest.skip(
                f"Python {sys.version_info.major}.{sys.version_info.minor} detected; skipping 3.11-only compatibility check"
            )
...
@pytest.mark.skipif(
    ...
    reason="Postgres saver integration tests are skipped in SQLite/offline mode",
)
